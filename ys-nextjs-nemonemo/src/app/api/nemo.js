...
export const compareNemoData = async (data) => {
  ...
  const comparisonResults = playNemoData.map((playRow) => {
    const matchingNemoRow = nemoData.find((nemoRow) => nemoRow.n_row_num === playRow.p_row_num);
    ...
    return (
      ...
      (playRow.p_block6 === undefined || playRow.p_block6 === matchingNemoRow.n_block6) &&
      (playRow.p_block7 === undefined || playRow.p_block7 === matchingNemoRow.n_block7) &&
      (playRow.p_block8 === undefined || playRow.p_block8 === matchingNemoRow.n_block8) &&
      (playRow.p_block9 === undefined || playRow.p_block9 === matchingNemoRow.n_block9) &&
      (playRow.p_block10 === undefined || playRow.p_block10 === matchingNemoRow.n_block10) &&
      (playRow.p_block11 === undefined || playRow.p_block11 === matchingNemoRow.n_block11) &&
      (playRow.p_block12 === undefined || playRow.p_block12 === matchingNemoRow.n_block12) &&
      (playRow.p_block13 === undefined || playRow.p_block13 === matchingNemoRow.n_block13) &&
      (playRow.p_block14 === undefined || playRow.p_block14 === matchingNemoRow.n_block14) &&
      (playRow.p_block15 === undefined || playRow.p_block15 === matchingNemoRow.n_block15)
    );
  });
