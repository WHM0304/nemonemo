  ...
  const gameaction = async (formData) => {
    ...
    for (let row of rows) {
      const game2Data = {
        ...
        p_block10: formData.get(`p_block${row}_10`) === "on" ? 1 : 0,
        p_block11: formData.get(`p_block${row}_11`) === "on" ? 1 : 0,
        p_block12: formData.get(`p_block${row}_12`) === "on" ? 1 : 0,
        p_block13: formData.get(`p_block${row}_13`) === "on" ? 1 : 0,
        p_block14: formData.get(`p_block${row}_14`) === "on" ? 1 : 0,
        p_block15: formData.get(`p_block${row}_15`) === "on" ? 1 : 0,
      };
      ...
      <section className="game-container">
            ...
            <form method="POST" onSubmit={handleSubmit}>
              {[
                ...
                <div key={row} className={`p_row_num${row} row`}>
                  ...
                  <input type="hidden" name="p_num" value={5} />
        ...
        <div className="clear">
          <form method="POST" action={checkCorrect}>
            ...
            <input name="p_num" value="5" hidden />
